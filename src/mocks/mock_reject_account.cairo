...
// Used to test invalid-signature revert paths in batch_settle and settle tests.

#[starknet::contract(account)]
pub mod MockRejectAccount {
    use openzeppelin_interfaces::accounts::{ISRC6, ISRC6_ID};
